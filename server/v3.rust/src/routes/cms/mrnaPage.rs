...
#[get("/cms/mrna")]                                                                            
pub async fn mrnaCmsRouteGet() -> Result<Json<response::GenericResponse<cms_content::CMSPage>>, Status> {
    let file_contents = std::fs::read_to_string("../data/responses/mrnaPage.json").expect("File should have been opened");
