...
function get3dPerlinNoise(point: vec3d, frequency: number): number {
  ...
  ((point: vec3d): number => {
    ...
    return lerp(
      lerp(lerp(permutationZ000, permutationZ100, distanceX0), lerp(permutationZ010, permutationZ110, distanceX0), distanceY0),
      lerp(lerp(permutationZ001, permutationZ101, distanceX0), lerp(permutationZ011, permutationZ111, distanceX0), distanceY0),
      distanceZ0
      ) * (1/permutationCount);
  })(point);
