    ...
    <IslandCenter>
      <div className="minesweeperPage">
        <div className="game-controls">
          <div className="game-control">
            <Modal closedChildren={<Gear variant="small" />}>
              <>
                ...
                <Input
                  label="Mine density:"
                  value={mineDensity.toString()}
                  onChange={e => {
                    setMineDensity(+(+e.target.value / 10).toFixed(3))
                    genFreshBoard()
                  }}
                />
              </>
          ...
          <div className="game-control">
            {(gameStateLookup as any)[gameState]}
          </div>
          <div className="game-control">
              ...
              {gridRow.map((cell: Cell, x: number) => (
                ...
                >
                  <button
                    ...
                    onMouseDown={e => {
                      setMousePressDuration(Date.now())
                    }}
                    onMouseUp={e => {
                      if (e.button !== 0) {
                        return
                      }
                      if (Date.now() - mousePressDuration > 300) {
                    ...
                    style={{
                      ...
                      backgroundColor: scheme.body.foreground,
                    }}
                  >
                    {cell.makeup === ""
                      ? cell.revealed
