...
function sendForumPostCreate(
  props: genericApiRequestArgs<ForumPostCreateRequestPayload>,
): Promise<
  AxiosResponse<genericApiDataResponse<ForumPostCreateResponsePayload>>
> {
