...
describe('Portfolio site e2e', () => {
  ...
  describe('Home page', () => {
    it('Displays the correct content', () => {
      ...
      cy.get('[data-test="home-external-link-container"]').children().first().should('have.text', 'GitHub').should('have.attr', 'href', 'https://github.com/KooperL')
      cy.get('[data-test="home-external-link-container"]').children().last().should('have.text', 'LinkedIn').should('have.attr', 'href', 'https://linkedin.com/in/kooper')
  ...
  describe('Projects page', () => {
    it('Displays the correct content', () => {
      ...
      cy.get('[data-test="title"]').first().should('contain', 'Published sites')
      cy.get('[data-test="title"]').first().next().should('have.attr', 'href', '/projects/bingoApp')
      cy.get('[data-test="title"]').next().next().should('have.attr', 'href', '/projects/pento')

      cy.get('[data-test="title"]').last().should('contain', 'My projects')
      cy.get('[data-test="title"]').last().next().should('have.attr', 'href', 'https://github.com/KooperL/svelte-pocketbase-quickstart')
      cy.get('[data-test="title"]').last().next().next().should('have.attr', 'href', 'https://github.com/KooperL/mdApp')
    })
    ...
    describe('Individual project links', () => {
      it('Links to bingo site', () => {
        ...
        cy.location('pathname', {timeout: 60000}).should('equal', '/projects/bingoApp');
      ...
      it('Links to pento site', () => {
        ...
        cy.location('pathname', {timeout: 60000}).should('equal', '/projects/pento');
  ...
  describe('Contact page', () => {
    ...
    describe('can submit a contact enquiry', () => {
      ...
      it('Submits without an email address', () => {
        ...
        cy.get('[data-test="name-input"]').clear().type(`2-${contactFormInput.name}{enter}`)
  
        cy.get('[data-test="message-input"]').type(`2-${contactFormInput.message}`)
