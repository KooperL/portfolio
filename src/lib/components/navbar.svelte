...
<Navbar class="flex flex-row">
  ...
  >
    ...
    >
      <HomeSolid
        class="text-gray-500 dark:text-gray-400 hover:bg-primary-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 w-10 h-10"
      />
    </span>
  </NavBrand>
