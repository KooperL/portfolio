...
export const projectContent = {
  gator_gang: {
    pageMetadata: {
      title: "Gator gang",
      description: "Gator gang is a co-presence multiplayer mod for lil gator game, allowing players to enjoy the game in a more social way. Each player retains their own progression, inventory, and story state. The goal is to enjoy the atmosphere together, explore side-by-side, and share moments.",
      headline: "Gator gang",
    },
    pageContent: {
      order: 2,
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "gator_gang-action-buttons",
              buttons: [
                {
                  id: "gator_gang-back-button",
                  label: "Back",
                  href: "/",
                  testId: "gator_gang-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["gator_gang", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "gator_gang-code-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["gator_gang", "Press on 'code' button"],
                    },
                  ],
                },
              ],
  ...
  pento: {
    pageMetadata: {
      title: "pento.page",
      description: "Pento is a user-friendly platform for sharing and storing text based content built with built from the ground up with privacy in mind. It allows users to quickly dump text, code, or any other content without the need for account registration and features the option to completely mask content by encrypting it. Engage with the community by leaving comments and ratings on submissions, and track the popularity of your content through view counts. Pento also offers API and CLI access, making it easy to integrate with your applications and workflows. Share your ideas seamlessly with Pento!",
      headline: "pento.page",
    },
    pageContent: {
      order: 2,
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "pento-action-buttons",
              buttons: [
                {
                  id: "pento-back-button",
                  label: "Back",
                  href: "/",
                  testId: "pento-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["pento", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "pento-visit-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["pento", "Press on 'visit' button"],
                    },
                  ],
                },
              ],
      ...
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "logridge-action-buttons",
              buttons: [
                {
                  id: "logridge-back-button",
                  label: "Back",
                  href: "/",
                  testId: "logridge-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["logridge", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "logridge-visit-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["logridge", "Press on 'visit' button"],
                    },
                  ],
                },
              ],
      ...
      elements: [
        {
          ...
          content: {
            ...
            title: "dropzones",
            body: [
              "Straight up bingo, with some multiplayer",
              "Check it out below!"
            ],
          },
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "bingo_app-action-buttons",
              buttons: [
                {
                  id: "bingo_app-back-button",
                  label: "Back",
                  href: "/",
                  testId: "bingo_app-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["bingo_app", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "bingo_app-visit-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["bingo_app", "Press on 'visit' button"],
                    },
                  ],
                },
              ],
      ...
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "mail_catcher-action-buttons",
              buttons: [
                {
                  id: "mail_catcher-back-button",
                  label: "Back",
                  href: "/",
                  testId: "mail_catcher-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["mail_catcher", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "mail_catcher-visit-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["mail_catcher", "Press on 'visit' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "mail_catcher-code-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["mail_catcher", "Press on 'code' button"],
                    },
                  ],
                },
              ],
      ...
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "md_app-action-buttons",
              buttons: [
                {
                  id: "md_app-back-button",
                  label: "Back",
                  href: "/",
                  testId: "md_app-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["md_app", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "md_app-visit-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["md_app", "Press on 'visit' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "md_app-code-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["md_app", "Press on 'code' button"],
                    },
                  ],
                },
              ],
        ...
        },
        {
          ...
          content: {
            order: 2,
            url: "https://mdapp-site.pages.dev/",
          },
        },
      ],
    },
      ...
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "pocketbase_logging-action-buttons",
              buttons: [
                {
                  id: "pocketbase_logging-back-button",
                  label: "Back",
                  href: "/",
                  testId: "pocketbase_logging-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["pocketbase_logging", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "pocketbase_logging-visit-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["pocketbase_logging", "Press on 'visit' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "pocketbase_logging-code-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["pocketbase_logging", "Press on 'code' button"],
                    },
                  ],
                },
              ],
      ...
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "redirected-action-buttons",
              buttons: [
                {
                  id: "redirected-back-button",
                  label: "Back",
                  href: "/",
                  testId: "redirected-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["redirected", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "redirected-visit-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["redirected", "Press on 'visit' button"],
                    },
                  ],
                },
              ],
  ...
  portfolio: {
    pageMetadata: {
      title: "portfolio",
      description: "The purpose of this project is to showcase my work and provide a platform for me to share my thoughts and ideas. Built with SvelteKit and TailwindCSS, this site is a playground for me to experiment with new technologies and ideas. Feel free to have a poke around the live site or the source code and let me know what you think!",
      headline: "portfolio",
    },
    pageContent: {
      order: 2,
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "portfolio-action-buttons",
              buttons: [
                {
                  id: "portfolio-back-button",
                  label: "Back",
                  href: "/",
                  testId: "portfolio-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["portfolio", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "portfolio-code-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["portfolio", "Press on 'code' button"],
                    },
                  ],
                },
              ],
      ...
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "vitality-action-buttons",
              buttons: [
                {
                  id: "vitality-back-button",
                  label: "Back",
                  href: "/",
                  testId: "vitality-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["vitality", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "vitality-visit-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["vitality", "Press on 'visit' button"],
                    },
                  ],
                },
              ],
  ...
  svelte_pocketbase_quickstart: {
    pageMetadata: {
      ...
      description: "Pure boiler plate project that I clone and fork every time I wish to quickly begin a new project. Quickly get started with a Svelte project that uses Pocketbase as a backend service. This project is a great starting point for any Svelte project that needs a backend service.",
      headline: "svelte-pocketbase-quickstart",
    },
    pageContent: {
      order: 2,
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "svelte_pocketbase_quickstart-action-buttons",
              buttons: [
                {
                  id: "svelte_pocketbase_quickstart-back-button",
                  label: "Back",
                  href: "/",
                  testId: "svelte_pocketbase_quickstart-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["svelte_pocketbase_quickstart", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "svelte_pocketbase_quickstart-visit-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["svelte_pocketbase_quickstart", "Press on 'visit' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "svelte_pocketbase_quickstart-code-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["svelte_pocketbase_quickstart", "Press on 'code' button"],
                    },
                  ],
                },
              ],
      ...
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "tailwind_color_generator-action-buttons",
              buttons: [
                {
                  id: "tailwind_color_generator-back-button",
                  label: "Back",
                  href: "/",
                  testId: "tailwind_color_generator-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["tailwind_color_generator", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "tailwind_color_generator-visit-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["tailwind_color_generator", "Press on 'visit' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "tailwind_color_generator-code-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["tailwind_color_generator", "Press on 'code' button"],
                    },
                  ],
                },
              ],
        ...
        },
        {
          ...
          content: {
            order: 2,
            url: "https://kooperl.github.io/tailwind-color-generator/",
          },
        },
      ],
    },
  ...
  simple_steganography: {
    pageMetadata: {
      ...
      headline: "Steganography encoder",
    },
    pageContent: {
      order: 2,
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "simple_steganography-action-buttons",
              buttons: [
                {
                  id: "simple_steganography-back-button",
                  label: "Back",
                  href: "/",
                  testId: "simple_steganography-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["simple_steganography", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "simple_steganography-visit-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["simple_steganography", "Press on 'visit' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "simple_steganography-code-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["simple_steganography", "Press on 'code' button"],
                    },
                  ],
                },
              ],
        ...
        },
        {
          ...
          content: {
            order: 2,
            url: "https://kooperl.github.io/simple-steganography/",
          },
        },
      ],
    },
  ...
  qr_encoder: {
    pageMetadata: {
      ...
      description: "Encode and decode files using QR code video streams — all in your browser. Any file can be encoded into a sequence of QR codes and later reconstruct the original file by scanning the QR codes from the video",
      headline: "QR File Encoder",
    },
    pageContent: {
      order: 2,
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "qr_encoder-action-buttons",
              buttons: [
                {
                  id: "qr_encoder-back-button",
                  label: "Back",
                  href: "/",
                  testId: "qr_encoder-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["qr_encoder", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "qr_encoder-visit-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["qr_encoder", "Press on 'visit' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "qr_encoder-code-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["qr_encoder", "Press on 'code' button"],
                    },
                  ],
                },
              ],
        ...
        },
        {
          ...
          content: {
            order: 2,
            url: "https://kooperl.github.io/qr-stream-generator/index.html",
          },
        },
      ],
    },
      ...
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "vybs-action-buttons",
              buttons: [
                {
                  id: "vybs-back-button",
                  label: "Back",
                  href: "/",
                  testId: "vybs-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["vybs", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  label: "Visit",
                  href: "https://vybs.tv/",
                  testId: "vybs-visit-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["vybs", "Press on 'visit' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "vybs-code-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["vybs", "Press on 'code' button"],
                    },
                  ],
                },
              ],
      ...
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "perf_gerber-action-buttons",
              buttons: [
                {
                  id: "perf_gerber-back-button",
                  label: "Back",
                  href: "/",
                  testId: "perf_gerber-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["perf_gerber", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "perf_gerber-visit-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["perf_gerber", "Press on 'visit' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "perf_gerber-code-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["perf_gerber", "Press on 'code' button"],
                    },
                  ],
                },
              ],
        ...
        },
        {
          ...
          content: {
            order: 2,
            url: "https://kooperl.github.io/perf-gerber/index.html",
          },
        },
      ],
    },
      ...
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "esp32_person_counter-action-buttons",
              buttons: [
                {
                  id: "esp32_person_counter-back-button",
                  label: "Back",
                  href: "/",
                  testId: "esp32_person_counter-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["esp32_person_counter", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "esp32_person_counter-code-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["esp32_person_counter", "Press on 'code' button"],
                    },
                  ],
                },
              ],
  ...
  geo_vic: {
    pageMetadata: {
      title: "geo-vic",
      description: "3D modeled and printed topographies/cityscapes in Victoria. Made with Blender and QGIS, contour lines sources from https://discover.data.vic.gov.au. Street map data from OSM.",
      headline: "geo-vic",
    },
    pageContent: {
      order: 2,
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "geo_vic-action-buttons",
              buttons: [
                {
                  id: "geo_vic-back-button",
                  label: "Back",
                  href: "/",
                  testId: "geo_vic-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["geo_vic", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "geo_vic-code-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["geo_vic", "Press on 'code' button"],
                    },
                  ],
                },
              ],
  ...
  prado_head_unit_plate: {
    pageMetadata: {
      ...
      description: "A collection of modifications and accessories to my car's head unit",
      headline: "prado-head-unit-plate",
    },
    pageContent: {
      order: 2,
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "prado_head_unit_plate-action-buttons",
              buttons: [
                {
                  id: "prado_head_unit_plate-back-button",
                  label: "Back",
                  href: "/",
                  testId: "prado_head_unit_plate-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["prado_head_unit_plate", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "prado_head_unit_plate-code-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["prado_head_unit_plate", "Press on 'code' button"],
                    },
                  ],
                },
              ],
      ...
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "audio_sniffer-action-buttons",
              buttons: [
                {
                  id: "audio_sniffer-back-button",
                  label: "Back",
                  href: "/",
                  testId: "audio_sniffer-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["audio_sniffer", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "audio_sniffer-code-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["audio_sniffer", "Press on 'code' button"],
                    },
                  ],
                },
              ],
  ...
  clover_pit_jumpstart: {
    pageMetadata: {
      ...
      description: "Mod for a game 'clover-pit' to enhance the early game setup. Made in C#. Provides a subtle early-game jumpstart to early game progression in CloverPit. The extra clover tickets and free restock smooth out the opening turns, letting players establish momentum faster without disrupting overall balance or progression.",
      headline: "clover-pit-jumpstart",
    },
    pageContent: {
      order: 2,
      elements: [
        ...
        },
        {
          ...
          content: {
            ...
            buttons: {
              order: 1,
              id: "clover_pit_jumpstart-action-buttons",
              buttons: [
                {
                  id: "clover_pit_jumpstart-back-button",
                  label: "Back",
                  href: "/",
                  testId: "clover_pit_jumpstart-back-button-testId",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["clover_pit_jumpstart", "Press on 'back' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "clover_pit_jumpstart-visit-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["clover_pit_jumpstart", "Press on 'visit' button"],
                    },
                  ],
                },
                {
                  ...
                  testId: "clover_pit_jumpstart-code-button-testId",
                  icon: "ArrowRightToBracketOutline",
                  events: [
                    {
                      name: "logInfo",
                      payload: ["clover_pit_jumpstart", "Press on 'code' button"],
                    },
                  ],
                },
              ],
