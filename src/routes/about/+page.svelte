...
<div class="box-border p-8 w-full h-full">
	<Card class="w-full max-w-full h-full bg-white/50">
		<div class="flex flex-col space-y-4 overflow-scroll" style="scrollbar-width: none;">
			<span class="text-4xl font-bold" data-test="title">About me</span>
			<div>
			<span class=" font-bold">I'm Kooper. We might have met already but I can't remember - I didn't want to annoy you with cookies.</span>
