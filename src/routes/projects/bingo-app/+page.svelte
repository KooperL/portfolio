<script lang="ts">
  ...
  const projectName = "dropzones";
  const projectDescription = ["Straight up bingo"];
  const projectPathVar = "bingo-app";
  const websiteUrl = "https://dropzones.io/";
  const githubUrl = undefined;
  const iframeUrl =
    "https://dropzones.io/" ?? "https://dropzones.io/sheet/3fv45nzt3gko5us";
