  ...
  <Card class="w-full max-w-full h-full bg-white/50">
    <div class="flex flex-col space-y-4">
      ...
      <div class="flex space-x-4">
        <Button
          on:click={(e) => {
            logger.debug("portfolio-page", 'Press "back" button');
          }}
          href="/"
          class="w-48"
        ...
        <Button
          on:click={(e) => {
            logger.debug("portfolio-page", 'Press "code" button');
          }}
        ...
        <Button
          ...
          variant="primary"
          on:click={() => {
            logger.debug("portfolio-page", 'Press "demo" button');
            alert("Demo? Are you not entertained??");
          }}>demo</Button
        >
      </div>
    </div>
