  ...
  <Card class="w-full max-w-full h-full bg-white/50">
    <div class="flex flex-col space-y-4">
      ...
      <div>
        ...
        <div
          class="h-96 aspect-square border-solid border-3 bg-primary-600 rounded box-border p-1 m-4 flex justify-center items-center"
        >
          <iframe src="https://vybs.tv" class="w-full h-full" />
        </div>
      </div>
      <div class="flex space-x-4">
        <Button on:click={(e) => {logger.debug('vybs-page','Press "back" button')}} href="/projects" class="w-48" variant="primary">back</Button>
        <Button on:click={(e) => {logger.debug('vybs-page','Press "visit" button')}} href="https://vybs.tv/" class="w-48" variant="primary"
