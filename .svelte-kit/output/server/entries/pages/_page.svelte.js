  ...
  return `<div class="box-border p-8 w-full h-full">${validate_component(Card, "Card").$$render(
    ...
    {},
    {
      default: () => {
        ...
        )} <span class="text-4xl font-bold" data-svelte-h="svelte-1jt5udw">External links</span> ${validate_component(Button, "Button").$$render(
          $$result,
          {
