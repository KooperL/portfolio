...
const Input = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Wrapper, "Wrapper").$$render(
    ...
    {
      default: () => {
        return `${$$slots.left ? `<div class="${escape(twMerge(floatClass, $$props.classLeft), true) + " start-0 ps-2.5 pointer-events-none"}">${slots.left ? slots.left({}) : ``}</div>` : ``} ${
          slots.default
            ? slots.default({
...
const Textarea = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    ...
    return `${validate_component(Wrapper, "Wrapper").$$render(
      ...
      {
        default: () => {
          return `${$$slots.header ? `<div${add_attribute("class", headerClass(true), 0)}>${slots.header ? slots.header({}) : ``}</div>` : ``} ${validate_component(
            Wrapper,
            "Wrapper",
          ).$$render(
            $$result,
            { show: wrapped, class: innerWrapperClass },
            {},
            {
              default: () => {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="box-border p-8 w-full h-full">${validate_component(
      ...
      {
        default: () => {
          return `<div class="flex flex-col space-y-4"><span class="text-4xl font-bold" data-svelte-h="svelte-hk2y0w">Contact me</span> <form><div class="flex flex-col space-y-4"><div>${validate_component(
            Label,
            "Label",
          ).$$render(
            $$result,
