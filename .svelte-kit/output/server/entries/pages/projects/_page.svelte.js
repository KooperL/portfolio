...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="box-border p-8 w-full h-full">${validate_component(Card, "Card").$$render(
    ...
    {
      default: () => {
        return `<div class="flex flex-col space-y-4"><span class="text-4xl font-bold" data-svelte-h="svelte-qomhdo">Published sites</span> ${validate_component(Button, "Button").$$render(
          $$result,
          {
        ...
        )} <span class="text-4xl font-bold" data-svelte-h="svelte-1fh6nt2">My projects</span> ${validate_component(Button, "Button").$$render(
          $$result,
          {
