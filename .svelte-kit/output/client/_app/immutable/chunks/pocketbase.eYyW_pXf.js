    ...
    super("ClientResponseError"),
      ...
      this.message ||
        (this.isAbort
          ...
          : (n =
                (i = (s = this.originalError) == null ? void 0 : s.cause) ==
                null
                  ? void 0
    ...
    return super.delete(e, t).then((s) => {
      ...
      return (
        s &&
          ...
          ((n = this.client.authStore.model) == null
            ? void 0
    ...
    return super.delete(e, t).then((s) => {
      ...
      return (
        !s ||
          ...
          (((n = this.client.authStore.model) == null
            ? void 0
            : n.collectionId) !== this.collectionIdOrName &&
            ((o = this.client.authStore.model) == null
              ? void 0
...
class Z {
  constructor(e = "/", t, s = "en-US") {
    (this.cancelControllers = {}),
      ...
      (this.baseUrl = e),
      (this.lang = s),
      (this.authStore = t || new $()),
      (this.admins = new G(this)),
      (this.collections = new V(this)),
      (this.files = new Y(this)),
      (this.logs = new z(this)),
